...
if __name__ == "__main__":
    ...
    create_dir("/content/drive/MyDrive/files_full_mesh")
    ...
    model_path='/content/drive/MyDrive/files_full_mesh/model.h5'
    batch_size = 6
    epochs = 100
    lr = 1e-4
    ...
    callbacks = [
        ...
        CSVLogger("/content/drive/MyDrive/files_full_mesh/data.csv"),
        TensorBoard(),
