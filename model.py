...
def full_mesh(e1, e2, e3, idx, num_filters, strides=1):
    
    e1, e2, e3 = CBAM(e1), CBAM(e2), CBAM(e3)
...
def build_resunet(input_shape):
    ...
    par1 = full_mesh(s1, s2, s3, 1, 64, strides=1)
    par2 = full_mesh(s1, s2, s3, 2, 64, strides=1)
    par3 = full_mesh(s1, s2, s3, 3, 64, strides=1)
